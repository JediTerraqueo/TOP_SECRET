...
def play_function(difficulty, font, test=False):
    ...
    while True:
        ...
        class aneis(object):
            ...
            def draw(self, win):
                if not self.azul and not self.verde and not self.vermelho:
                    win.blit(self._0_anel, (self.x, self.y))
                elif self.azul and not self.verde and not self.vermelho:
                    win.blit(self._1_a_anel, (self.x, self.y))
                elif not self.azul and not self.verde and self.vermelho:
                    win.blit(self._1_v_anel, (self.x, self.y))
                elif not self.azul and self.verde and not self.vermelho:
                    win.blit(self._1_ve_anel, (self.x, self.y))
                elif self.azul and not self.verde and not self.vermelho:
                    win.blit(self._2_anel_ve_a, (self.x, self.y))
                elif self.azul and self.verde and not self.vermelho:
                    win.blit(self._2_anel_v_a, (self.x, self.y))
                elif self.azul and self.verde and self.vermelho:
        ...
        class anel_1(object):
            ...
            def draw_taking(self, win):
                win.blit(self.anel_v_t, (self.x, self.y))
        ...
        while run:
            while run:
                ...
                if anel_1.visible:
                    if man.hitbox[1] < anel_1.hitbox[1] + heal.hitbox[3] and man.hitbox[1] + man.hitbox[3] > anel_1.hitbox[1]:
                        if man.hitbox[0] + man.hitbox[2] > anel_1.hitbox[0] and man.hitbox[0] < anel_1.hitbox[0] + anel_1.hitbox[2]:
                            anel_1.draw_taking(win)
